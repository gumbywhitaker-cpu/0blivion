  ...
  return (
    <div className="flex flex-1 flex-col bg-kf-green-900 text-white">
      <header className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-6">
        <span className="text-xl font-semibold tracking-tight">KiwiFlow</span>
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-start justify-center gap-6 px-6 py-16">
