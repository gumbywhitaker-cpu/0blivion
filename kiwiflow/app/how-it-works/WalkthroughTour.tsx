...
const STEPS: Step[] = [
  ...
  {
    title: "7. Compliance records",
    who: "Grower / packhouse",
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_1.4fr]">
        <div className="flex flex-col gap-4">
          <div>
            <span className="mb-2 inline-block rounded-full bg-kf-green-100 px-2.5 py-1 text-xs font-semibold text-kf-green-700">
              {step.who}
            </span>
